...
// Shield SVG Component with animation-ready structure
...
const BlockingScreen: React.FC<BlockingScreenProps> = ({ navigation, route }) => {
    ...
    useEffect(() => {
        // Get a new random message when screen mounts
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <View style={styles.content}>
                ...
                <TouchableOpacity
                    style={[styles.refreshButton, { backgroundColor: theme.cardBackground }]}
